...
| New Rust/Tauri lite final single exe after release-size tuning and migration hardening | `release-single\ScreenWatchOCRTauri.exe` | 3,587,072 bytes, about 3.42 MiB |
