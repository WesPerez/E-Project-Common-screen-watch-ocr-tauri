...
| Production template smoke | Latest continuation rerun against the real shared `profile_1.json`: 18/18 matched on 2560x1440 synthetic placement; 7319ms recorded with threshold 0.90, scales 1.0, and template_workers 2 |
...
| Template target detection, scales, worker limit | Proven | Rust detector tests, parity/benchmark gates | Current production-profile smoke records about 7.3s for 18 real templates on synthetic 1440p placement; acceptable but worth tracking |
