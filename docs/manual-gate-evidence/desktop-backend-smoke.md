...
Release build-info hash: desktop backend gates run against source/test binaries; current final single exe is separately recorded as 200C0C8E8EFB8AF4A2DD56A37C9762C2582C45DB441555E669A114AF5D1737B2, 3587584 bytes, WindowsGui subsystem verified by singleFileDeliverableContract.
