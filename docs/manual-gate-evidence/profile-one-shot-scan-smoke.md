...
Date/time: 2026-07-07T13:22:20.210Z
Machine: DESKTOP-9FRQ8VV
Worktree note: Tauri repo present; smoke used isolated LOCALAPPDATA and did not modify the Python baseline
Command(s) and exit code(s): node scripts/webview-visual-smoke.mjs --exe-path .\release-single\ScreenWatchOCRTauri.exe --gate scan; exit 0
...
Model/image/evidence dirs: generated input fixture directory was not retained for this focused gate; localAppData=E:\Project\Common\screen-watch-ocr-tauri\target\webview-visual-smoke\20260707-212214\localappdata; evidenceLogDir=E:\Project\Common\screen-watch-ocr-tauri\docs\manual-gate-evidence\logs
...
Evidence files: docs\manual-gate-evidence\logs\webview-visual-smoke-20260707-212214-result.json; docs\manual-gate-evidence\logs\webview-visual-smoke-20260707-212214-app.log; docs\manual-gate-evidence\logs\profile-one-shot-scan-prepared-20260707-212214.png; docs\manual-gate-evidence\logs\profile-one-shot-scan-hit-20260707-212214.png
