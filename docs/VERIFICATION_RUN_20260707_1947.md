...
| Old/new coexistence | Earlier full coexistence proof remains valid for the separated process/protocol design. A fresh current-hash default-port coexistence rerun remains pending because an existing old Python app already owned port `47627`; the safety guard correctly refuses to touch it. |
